    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Mouths", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FarmPlayer", x => new { x.FarmsId, x.PlayersId });
                    table.ForeignKey(
                        name: "FK_FarmPlayer_Farms_FarmsId",
                        column: x => x.FarmsId,
                        principalTable: "Farms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FarmPlayer_Players_PlayersId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NextFeedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    NextDrinkDate = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NoseId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PetBodies_Bodies_BodyId",
                        column: x => x.BodyId,
                        principalTable: "Bodies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PetBodies_Eyes_EyesId",
                        column: x => x.EyesId,
                        principalTable: "Eyes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PetBodies_Mouths_MouthId",
                        column: x => x.MouthId,
                        principalTable: "Mouths",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PetBodies_Noses_NoseId",
                        column: x => x.NoseId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PetBodies_EyesId",
                table: "PetBodies",
                column: "EyesId");

            migrationBuilder.CreateIndex(
                name: "IX_PetBodies_MouthId",
                table: "PetBodies",
                column: "MouthId");
